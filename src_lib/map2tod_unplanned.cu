    ...
    bool partial_pixelization)
{
    ...
    unplanned_map2tod_kernel<T,W> <<< nblocks, {32,W} >>>
	(tod.data,                                  // T *tod
    ...
    check_gpu_errflags(errflags.data, nblocks, "unplanned_map2tod", errflags_to_ignore);
}


#define INSTANTIATE(T) \
    template void launch_unplanned_map2tod( \
	Array<T> &tod, \
