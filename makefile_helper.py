...
python_incdir = distutils.sysconfig.get_config_var('INCLUDEPY')
print("# Include directory for python headers", file=s)
print("# From distutils.sysconfig.get_config_var('INCLUDEPY')", file=s)
...
pyext_suffix = distutils.sysconfig.get_config_var('EXT_SUFFIX')
print("# Filename suffix for python extension modules", file=s)
print("# From distutils.sysconfig.get_config_var('EXT_SUFFIX')", file=s)
